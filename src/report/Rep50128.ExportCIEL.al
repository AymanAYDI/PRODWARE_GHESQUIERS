report 50128 "PWD Export CIEL"
{
    ...
    var
        TemXMLBuffer: Record "XML Buffer" temporary;
        RecGCIELData: Record 50021;
        ...
        CstG007: label 'EDI DTI+ CIEL file has been generated.';
        DecGQtyMoutsJus: Decimal;
        DecGQtyMoutsMcr: Decimal;
        DecGQtyVinVinaigre: Decimal;
        //CduGCommonDialogMgt: Codeunit 412;
        CduG3TierAutomationMgt: Codeunit 419;
}
