...
{
    DefaultLayout = RDLC;
    RDLCLayout = './rdl/Apurementfindemois.rdlc';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(STRSUBSTNO_Text006__Tariff_No___TariffNumber_Description_; STRSUBSTNO(Text006, "Tariff No.", TariffNumber.Description))
            {
            }
