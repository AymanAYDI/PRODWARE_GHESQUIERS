codeunit 60001 "PWD Function Mgt"
{
    ...
    begin
        ...
        IF RecSalesHeader.FindFirst() THEN BEGIN
            ...
            //
            SalesHeaderArchive.SETRANGE("Document Type", RecSalesHeader."Document Type");
            SalesHeaderArchive.SETRANGE("No.", RecSalesHeader."No.");
            if not ((not SalesHeaderArchive.IsEmpty()) and (RecSalesHeader."PWD Call Type" = '')) then
                //
