...
{//TODO Automation
 ...
 //TODO
     ...
     local procedure ExecuteMerge(var wrdApp: Automation; var SalesLine: Record "Sales Line" temporary; Attachment: Record "PWD Customs Documents Template"; TemplateCode: Code[10])
     var
     ...
     procedure ShowMergedDocument(var SalesLine: Record "Sales Line" temporary; var Attachment: Record "PWD Customs Documents Template"; WordCaption: Text[260]; IsTemporary: Boolean; TemplateCode: Code[10])
     var
         Country2: Record "Country/Region";
         CompanyInfo: Record "Company Information";
         ShipmentMethod: Record "Shipment Method";
