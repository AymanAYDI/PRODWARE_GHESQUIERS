codeunit 50000 "PWD Customs Sales Doc WordMngt"
{
    ...
    procedure OpenWordAttachment(var Attachment: Record "Customs Documents Template"; FileName: Text[260]; Caption: Text[260]; IsTemporary: Boolean)
    var
        wrdApp: Automation;
        wrdDoc: Automation;
        wrdMergefile: Automation;
    ...
    procedure Merge(var SalesLine: Record "Sales Line" temporary; var Attachement: Record "PWD Customs Documents Template"; TemplateCode: Code[10])
    var
        wrdApp: Automation;
        wrdMergefile: Automation;
        WordHided: Boolean;
    ...
    local procedure ExecuteMerge(var wrdApp: Automation; var SalesLine: Record "Sales Line" temporary; Attachment: Record "Customs Documents Template"; TemplateCode: Code[10])
    var
        Country2: Record "Country/Region";
        CompanyInfo: Record "Company Information";
        ShipmentMethod: Record "Shipment Method";
        PaymentTerms: Record "Payment Terms";
        WordTemplate: Record "Customs Documents Template";
        wrdDoc: Automation;
        wrdMergefile: Automation;
    ...
    begin
            ...
            CASE WordTemplate.Correspondence OF
                ...
                WordTemplate.Correspondence::"E-Mail":
                    BEGIN
                        ...
                        //        Mail.NewMessage(
                        //             FindMail(SalesLine),'',
                        //             FORMAT(SalesLine."Document Type") + ' ' + SalesLine."No.",'',MainFileName,FALSE);
        ...
        AddField(SalesLine."No.");
        AddField(FORMAT(SalesLine."Shipment Date", 0, 4));
        AddField(SalesLine.Description);
        AddField(SalesLine."Bill-to Customer No.");
        AddField(FORMAT(SalesLine."Output Date"));
        AddField(SalesLine."Health Approval No.");
        AddField(SalesLine.Marked);
        AddField(FORMAT(Item."Conserving Temperature"));
        AddField(FORMAT(Item."Transport Temperature"));
        ...
        */
        ...
        //InsertExcelTable(wrdApp,wrdDoc,SalesLine,TemplateCode);
        ...
        CASE WordTemplate.Correspondence OF
            ...
            WordTemplate.Correspondence::"E-Mail":
                BEGIN
                    ...
                    wrdDoc.MailMerge.MailAddressFieldName := Text015;
                    wrdDoc.MailMerge.MailSubject := FORMAT(SalesLine."Document Type") + ' ' + SalesLine."No.";
    ...
    procedure ShowMergedDocument(var SalesLine: Record "Sales Line" temporary; var Attachment: Record "Customs Documents Template"; WordCaption: Text[260]; IsTemporary: Boolean; TemplateCode: Code[10])
    var
        Country2: Record "Country/Region";
        CompanyInfo: Record "Company Information";
        ShipmentMethod: Record "Shipment Method";
    ...
    begin
        ...
        END ELSE BEGIN
            ...
            AddField(CompanyInfo."Phone No.");
            AddField(CompanyInfo."Fax No.");
            AddField(FORMAT(SalesLine."Document Type"));
            AddField(SalesLine."No.");
            AddField(FORMAT(SalesLine."Shipment Date", 0, 4));
            AddField(SalesLine.Description);
            AddField(SalesLine."Bill-to Customer No.");
            ...
            //  WordHandler(wrdDoc,Attachment,WordCaption,IsTemporary,MainFileName);
        END;
    ...
    begin
        ...
        AddField(SalesLine.TABLECAPTION + ' ' + SalesLine.FIELDCAPTION("Document Type"));
        AddField(SalesLine.TABLECAPTION + ' ' + SalesLine.FIELDCAPTION("No."));
        AddField(SalesLine.TABLECAPTION + ' ' + SalesLine.FIELDCAPTION("Shipment Date"));
        AddField(SalesLine.TABLECAPTION + ' ' + SalesLine.FIELDCAPTION(Description));
        AddField(SalesLine.TABLECAPTION + ' ' + SalesLine.FIELDCAPTION("Bill-to Customer No."));
        AddField(SalesLine.TABLECAPTION + ' ' + SalesLine.FIELDCAPTION("Output Date"));
        AddField(SalesLine.TABLECAPTION + ' ' + SalesLine.FIELDCAPTION("Health Approval No."));
        AddField(SalesLine.TABLECAPTION + ' ' + SalesLine.FIELDCAPTION(Marked));
        ...
        FOR I := 1 TO 8 DO
            AddField(SalesHeader.TABLECAPTION + ' ' + TextShipAddr + ' ' + FORMAT(I));
    ...
    procedure WordHandler(var wrdDoc: Automation; var Attachment: Record "Customs Documents Template"; Caption: Text[260]; IsTemporary: Boolean; FileName: Text[260]) DocImported: Boolean
    var
        Attachment2: Record "Customs Documents Template";
    ...
    procedure DocContainMergefields(var Attachment: Record "Customs Documents Template") MergeFields: Boolean
    var
        [WithEvents]
        wrdApp: Automation;
        wrdDoc: Automation;
